(function (c) {
  ...
  function b(f, e) {
    ...
    e.prepend('<div class="plupload_wrapper plupload_scroll"><div id="' + f
                  ...
                  + a("Select files") + '</div><div class="plupload_header_text">'
                  ...
                  + a("Status") + '</span></div><div class="plupload_file_size">' + a("Size")
                  + '</div><div class="plupload_clearer">&nbsp;</div></div><ul id="' + f
                  ...
                  + a("Add files") + '</a><a href="#" class="plupload_button plupload_start">' + a("Start upload")
                  ...
                  + f + '_count" name="' + f + '_count" value="0" /></div>')
  }
    ...
    if (e) {
      this.each(function () {
        ...
        function f() {
          ...
          c("span.plupload_upload_status", i).text(a("Uploaded %d/%d files").replace(/%d\/%d/,
        ...
        function g() {
          ...
          c.each(j.files, function (p, o) {
            ...
            if (o.status == plupload.DONE) {
              if (o.target_name) {
                l +=
                '<input type="hidden" name="' + k + "_" + n + '_tmpname" value="' + plupload.xmlEncode(o.target_name)
                    + '" />'
              }
              l += '<input type="hidden" name="' + k + "_" + n + '_name" value="' + plupload.xmlEncode(o.name) + '" />';
              l += '<input type="hidden" name="' + k + "_" + n + '_status" value="' + (o.status
                  == plupload.DONE ? "done" : "failed") + '" />';
              n++;
              c("#" + k + "_count").val(n)
            }
            m.append('<li id="' + o.id + '"><div class="plupload_file_name"><span>' + o.name
                         + '</span></div><div class="plupload_file_action"><a href="#"></a></div><div class="plupload_file_status">'
                         + o.percent + '%</div><div class="plupload_file_size">' + plupload.formatSize(o.size)
                         + '</div><div class="plupload_clearer">&nbsp;</div>' + l + "</li>");
            h(o);
          ...
          c("a.plupload_start", i).toggleClass("plupload_disabled",
        ...
        j.bind("Init", function (l, m) {
          ...
          c("#" + k + "_container").attr("title", a("Using runtime: ") + m.runtime);
